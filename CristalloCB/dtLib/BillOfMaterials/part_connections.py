...
def parse_connection():
    ...
    connectiondic = {}
    datafile = pd.ExcelFile("./dtApp/static/BoM.xlsx")
    ...
    pd_connectiondic.to_csv("./dtApp/static/connectionparse.csv")
...
def component_connection_list():
    ...
    with open("./dtApp/static/part_connectiontype.json", 'r') as f:
        typedic = json.load(f)
